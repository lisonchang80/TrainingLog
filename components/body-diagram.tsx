 ...
 */
function FrontBody({ highlight }: BodyDiagramProps) {
 ...
 */
function BackBody({ highlight }: BodyDiagramProps) {
  const f = (id: string) => fillFor(highlight, id);
  return (
    <Svg viewBox="0 0 200 400" width={140} height={280}>
      {/* Head */}
 ...
 */
export function BodyDiagram({ highlight }: BodyDiagramProps) {
  return (
    <View style={styles.row}>
      <View style={styles.column}>
        <Text style={styles.label}>正面</Text>
        <FrontBody highlight={highlight} />
      </View>
      <View style={styles.column}>
        <Text style={styles.label}>背面</Text>
        <BackBody highlight={highlight} />
      </View>
    </View>
  );
}
