...
export const strings = {
  zh: {
    ...
    status: {
      ...
      castToWatchFailedUnpaired: '投影失敗：未配對 Apple Watch',
      castToWatchFailedNoApp: '投影失敗：手錶未安裝 App',
      castToWatchFailedBusy: '投影失敗：手錶有其他進行中的訓練',
    ...
    onboarding: {
      skip: '跳過',
      step: '步驟',
      welcomeTitle: '歡迎使用 TrainingLog',
      welcomeBody:
        '專注記錄你的重量訓練——快速記下每一組、追蹤進步、回顧歷史。先花一分鐘做點基本設定。',
      expTitle: '你的訓練經驗',
      expQuestion: '你有重量訓練的經驗嗎？',
      expBeginner: '我是新手',
      expBeginnerHint: '剛開始、想簡單一點',
      expExperienced: '我有經驗',
      expExperiencedHint: '想用完整的計劃功能',
      modeTitle: '建議的模式',
      modeBody: '之後隨時可以在「設定」裡更改。',
      modeMinimal: '極簡模式',
      modeMinimalHint: '隱藏計劃與強度，只列出模板、點一下就開始。',
      modePlan: '計劃模式',
      modePlanHint: '完整功能：週期計劃、強度分類、行事曆。',
      recommended: '推薦',
      bodyTitle: '記錄身體數據',
      bodyBody: '選填。之後可在「身體數據」頁隨時新增。',
      healthTitle: '連結 Apple 健康',
      healthBody:
        '連結後，完成的訓練會寫進 Apple「健康 / Fitness」；搭配 Apple Watch 時也會記錄訓練心率與消耗熱量。',
      sectionTitle: '新手引導',
      rerunEntry: '重新查看新手引導',
    },
  },
  ...
  en: {
    ...
    status: {
      ...
      castToWatchFailedUnpaired: 'Cast failed — no Apple Watch paired',
      castToWatchFailedNoApp: 'Cast failed — app not installed on Watch',
      castToWatchFailedBusy: 'Cast failed — Watch is in another session',
    ...
    onboarding: {
      skip: 'Skip',
      step: 'Step',
      welcomeTitle: 'Welcome to TrainingLog',
      welcomeBody:
        'Focus on logging your strength training — record every set, track progress, review history. Let’s spend a minute on a few basics.',
      expTitle: 'Your training experience',
      expQuestion: 'Have you done weight training before?',
      expBeginner: "I'm new to it",
      expBeginnerHint: 'Just starting — keep it simple',
      expExperienced: 'I have experience',
      expExperiencedHint: 'I want the full planning features',
      modeTitle: 'Recommended mode',
      modeBody: 'You can change this anytime in Settings.',
      modeMinimal: 'Minimal mode',
      modeMinimalHint: 'Hides plans & intensity — just tap a template to start.',
      modePlan: 'Plan mode',
      modePlanHint: 'Full features: cycle plans, intensity tags, calendar.',
      recommended: 'Recommended',
      bodyTitle: 'Record your body data',
      bodyBody: 'Optional. You can add more anytime on the Body data page.',
      healthTitle: 'Connect Apple Health',
      healthBody:
        'Once connected, finished workouts are saved to Apple Health / Fitness; paired with an Apple Watch, your training heart rate and calories are recorded too.',
      sectionTitle: 'Getting started',
      rerunEntry: 'Replay the intro',
    },
  },
} as const;
